...
<body>
    <header>
        <div class="container">
            ...
            <div class="links">
                <ul>
                    <li><form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" onsubmit="return confirm('Are you sure you want to sign out?');">
            ...
            <div class="row">
                <div class="card">
                    ...
                    <button class="hero-btn">
                        <a href="LanguageRequests.html">View Requests</a>
                    </button>
                </div>
