...
<body>
    <div class="big-wrapper light">
        ...
        <div class="container">    
            ...
            <table>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>$" . $row["sessionPricePerHour"] * ($row["duration"] / 60) . "</td>";
                    echo "<td><a href='RatePartner.php'><button id='save-btn'>Review Partner</button></a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
        ...
        <?php 
                ...
                echo "<p>You don't have any previous sessions.</p>";
            }
            ?>
        </div>
