...
$(function () {
    ...
    $("#button1").on("click", function() {
        ...
        let rating = $(".container1 .fa-star.checked").length;

        // Get the review text
        let reviewText = $("#review").val();

        // Here you can add your code to submit the review
        console.log("Rating: " + rating);
        console.log("Review: " + reviewText);

        // Redirect to ConfirmSubmitReview.html
        window.location.href = "ConfirmSubmitReview.html";
    });
});